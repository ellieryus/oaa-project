...
export const ALUMNI: AlumnusProfile[] = [
  {
    ...
    customMessage:
      "I prep for these. So come ready — share a doc, a question, a goal. Vague messages get vague answers.",
    background: [
    ...
    nonOfferings: [
      { id: "job-referral",        title: "Job referral"        },
  ...
  },
  {
    ...
    nonOfferingsQuote:
      "I'm happy to help with story and positioning. For SQL and coding prep, find someone on the engineering side.",
  ...
  },
  {
    ...
    nonOfferingsQuote:
      "I'm good at interview prep, not resume polish. If you want to practice thinking like a data scientist, let's talk.",
  ...
  },
  {
    ...
    nonOfferingsQuote:
      "I'm a technical person. If you want SQL help or to talk about data platforms, I'm great. Soft skills coaching is not my thing.",
  ...
  },
  {
    ...
    background: [
      ...
      { company: "Intact",      role: "Intern",                                       start: "2017", end: "2017" },
    ],
    ...
    nonOfferingsQuote:
      "I help with the people side of analytics careers. If you're aiming for DS or engineering, I'm not your person.",
    availabilityDays: ["Tue", "Thu"],
    availabilitySlots: [
  ...
  },
  {
    ...
    nonOfferingsQuote:
      "I'm great for PM track questions. If you're targeting pure data science, I'd point you toward someone on the engineering side.",
...
/** The three alumni surfaced on the student's current match set */
