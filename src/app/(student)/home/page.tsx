...
function RequestStatusPill({ status }: { status: string }) {
  return (
    <span className="inline-flex items-center gap-1.5 rounded-full border border-border bg-card px-2.5 py-1">
      <span className={`h-1.5 w-1.5 rounded-full ${STATUS_DOT[status] ?? "bg-neutral-400"}`} />
    ...
    <div className="min-h-screen bg-background">
            ...
            <div className="px-6 py-5">
              <div className="flex items-center gap-3 rounded-md border border-border bg-card p-4">
                ...
                <div className="min-w-0">
                  <p className="text-sm font-semibold text-foreground">{unreflectedReq.alumniName}</p>
      ...
      <main className="mx-auto max-w-[1200px] px-8 py-12">
        ...
        <section className="mb-12">
          ...
          <h2 className="mb-5 text-xl font-semibold leading-[1.2] text-foreground">
            ...
            {TOP_3.map((alumnus) => (
              ...
              >
                ...
                <Link
                  ...
                  className="mt-auto flex items-center gap-1 text-sm text-brand-500 hover:underline"
                >
                  View profile
                  <ArrowRight className="h-4 w-4" strokeWidth={1.5} aria-hidden />
                </Link>
        ...
        <section>
          <div className="mb-4 flex items-center justify-between">
            <h2 className="text-xl font-semibold leading-[1.2] text-foreground">
              Active requests
            </h2>
            {/* Bug 5 — ArrowRight */}
            <Link
